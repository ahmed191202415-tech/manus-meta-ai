...
META_OAUTH_SCOPES = os.getenv(
    "META_OAUTH_SCOPES",
    "ads_management,ads_read,business_management,leads_retrieval,pages_show_list,pages_read_engagement,pages_manage_ads,pages_manage_posts,pages_manage_engagement,pages_manage_metadata,pages_messaging"
)
...
GPT_RESPONSE_MAX_BYTES = int(os.getenv("GPT_RESPONSE_MAX_BYTES", "350000"))
